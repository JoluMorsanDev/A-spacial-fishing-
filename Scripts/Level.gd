...
func _on_Wormhole_add_score():
	...
	score += 200
	if score >= 600 and startspawn == false:
...
func _on_Enemie1Timer_timeout():
	...
	$Enemies/Enemie1Timer.wait_time = clamp($Enemies/Enemie1Timer.wait_time, 1.5, INF)
...
func _on_Enemie2Timer_timeout():
	...
	$Enemies/Enemie2Timer.wait_time = clamp($Enemies/Enemie2Timer.wait_time, 2.5, INF)
...
func _on_Ui_game_over():
	$Ui/GameOverUI/Label.text = "Game Over"
